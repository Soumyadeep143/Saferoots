...
function HomePage({ onNavigate }) {
  return (
    <div className="space-y-12">
      ...
      {/* Core Mission */}
      <div className="bg-gradient-to-r from-emerald-500/10 to-blue-500/10 border border-emerald-500/30 rounded-xl p-8 mb-8">
        <h3 className="text-2xl font-bold text-white mb-2">Learn Calibrated Trust</h3>
...
function FeatureCard({ icon: Icon, title, description, color }) {
  return (
    <div className="bg-gradient-to-br from-slate-800/40 to-slate-700/40 rounded-xl p-6 border border-slate-600/50 hover:border-blue-500/50 transition-all hover:scale-105">
      <div className={`p-3 bg-gradient-to-br ${color} rounded-lg w-fit mb-3`}>
...
function CTACard({ title, description, action, icon: Icon, color }) {
  ...
  return (
    <button
      onClick={action}
      className={`bg-gradient-to-br ${colorMap[color]} rounded-2xl p-6 border transition-all hover:scale-105 text-left group`}
    >
