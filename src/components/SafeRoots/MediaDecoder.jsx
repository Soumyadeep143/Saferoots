...
const CULTURAL_PHRASES = [
  {
    ...
    phrases: [
      ...
      {
        phrase: 'Dhoka khana',
        englishTranslation: 'To be betrayed or deceived',
        literalMeaning: 'Literally means "to eat betrayal" but idiomatically means "to be cheated or let down"',
        socialContext: 'Used when someone tricks you or lets you down in a business deal or relationship. Expresses disappointment or mild frustration.',
        ...
        culturalNotes: 'Common in casual conversations and market settings in India. Shows someone broke your trust.',
      },
      {
